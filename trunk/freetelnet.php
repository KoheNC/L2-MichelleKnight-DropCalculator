...
if ($evaluser)
{
	...
	else
	{
		...
		echo "<p class=\"popup\">Issue free form telnet command</p>";
		echo "	
		<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"popup\">
		<tr>
		<td class=\"popuptrans\"><form action=\"freetelnet.php\"><input name=\"sendchat\" maxlength=\"93\" size=\"50\" type=\"text\" value=\"\" class=\"popup\"></td></tr>
		<tr><td class=\"popuptrans\" align=\"left\"><input value=\"Issue Telnet Command\" onclick=\"submit\" height=\"9\" type=\"submit\" class=\"popupcentre\">
