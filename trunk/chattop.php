...
if ($evaluser)
{
	...
	echo "<p class=\"popup\">Chatting to $touser</p>";
	...
	else
	{
		...
		if ($sendchat)
		{
			...
			else
			{
				...
				if($usetelnet)
				{
					$give_string = 'msg ' . $touser . ' (' . $id . ') ' . $sendchat;
		...
		echo "	<form action=\"chattop.php\">
		<table border=\"0\" cellpadding=\"5\" cellspacing=\"0\" class=\"popup\">
		<tr>
		<td class=\"popuptrans\" colspan=\"2\" height=\"15\"><input class=\"dropmain\" height=\"25\" name=\"sendchat\" maxlength=\"93\" size=\"50\" type=\"text\" value=\"\" class=\"popup\"></td></tr>
		<tr><td class=\"popuptrans\" align=\"left\" valign=\"top\"><input value=\"Send Chat\" onclick=\"submit\" height=\"9\" type=\"submit\" class=\"popupcentre\"></td>
		...
		<td class=\"popuptrans\" align=\"right\"><form action=\"chattop.php\">
		<input name=\"username\" type=\"hidden\" value=\"$username\">
		<input name=\"token\" type=\"hidden\" value=\"$token\">
		<input name=\"langval\" type=\"hidden\" value=\"$langval\"><input name=\"server_id\" value=\"$server_id\" type=\"hidden\"><input name=\"skin_id\" value=\"$skin_id\" type=\"hidden\">
		<input name=\"touser\" type=\"hidden\" value=\"$touser\">
		<input name=\"sendchat\" type=\"hidden\" value=\"Dont worry about the -Telnet is not logged in- message, I still see what you type back to me.\">
		<input value=\"Send 'don't worry'\" onclick=\"submit\" height=\"9\" type=\"submit\" class=\"popupcentre\"></form></td>
		</tr></table>
